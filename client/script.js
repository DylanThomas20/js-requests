...
/*
    ...
    Outside of the function, select the button with the id "repeat-button" and add 
    a click event listener that calls the repeatMyParam function.
...
const queryButton = () => {
    axios.get('http://localhost:3000/query-test/?name=Kesley')
    .then((res) => {
        console.log(res.data)
    })
    .catch((error) => {
